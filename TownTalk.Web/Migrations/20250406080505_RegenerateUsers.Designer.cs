...
namespace TownTalk.Web.Migrations
{
    ...
    [Migration("20250406080505_RegenerateUsers")]
    partial class RegenerateUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TownTalk.Web.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TownTalk.Web.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TownTalk.Web.Models.Comment", b =>
                {
                    ...
                    b.HasOne("TownTalk.Web.Models.ApplicationUser", "User")
                        .WithMany("Comments")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("TownTalk.Web.Models.Notification", b =>
                {
                    ...
                    b.HasOne("TownTalk.Web.Models.ApplicationUser", "Sender")
                        .WithMany()
                        .HasForeignKey("SenderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TownTalk.Web.Models.ApplicationUser", "TaggedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TownTalk.Web.Models.UserFollow", b =>
                {
                    b.HasOne("TownTalk.Web.Models.ApplicationUser", "Followed")
                        .WithMany("Followers")
                        .HasForeignKey("FollowedId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TownTalk.Web.Models.ApplicationUser", "Follower")
                        .WithMany("Following")
