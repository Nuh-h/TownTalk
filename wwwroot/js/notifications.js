class NotificationsModule {
    ...
    initViewPostEvents() {
        $(this.viewNotificationButtonSelector).off("click").on("click", (e) => {
            ...
            if ($(this).closest(`li[data-notification-id=${notificationId}]`).hasClass("notification-unread")) {
    ...
    markNotificationAsRead(notificationId) {
        this.connection.invoke("MarkNotificationAsRead", parseInt(notificationId)).catch(err => {
            console.error(err);
        });
    }
}
